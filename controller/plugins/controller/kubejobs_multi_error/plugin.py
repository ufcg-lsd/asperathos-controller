...
from controller.plugins.controller.kubejobs_multi_error.alarm import MultiErrorKubeJobs
...
class KubejobsMultiErrorController(Controller):
    ...
    def __init__(self, application_id, parameters):
        ...
        self.alarm = MultiErrorKubeJobs(parameters)
